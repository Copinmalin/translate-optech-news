...
def fetch(url: str) -> requests.Response:
    headers = {"User-Agent": "optech-fr-md/4.0 (+https://bitcoinops.org)"}
...
def process_one(en_url: str, output_dir: Path, model: str, overwrite: bool = False) -> dict:
    ...
    try:
        ...
        translated_body = wrap_markdown(translated_body, preferences.get("wrap_width", 72))
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Traduit en français les newsletters Bitcoin Optech depuis le Markdown source du dépôt upstream avec normalisation de style.")
